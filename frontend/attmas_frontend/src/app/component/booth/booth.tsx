...
// // Convert string to ObjectId-like format
...
//   //   try {
//   //     // Convert product IDs to ObjectId format
//   //     const convertedProductIds = values.products.map((id) => toObjectId(id));
//   //     const payload = { ...values, products: convertedProductIds };
