...
// export interface LatestProductForBooth {
//   _id: string;
//   id: string;
//   productName: string;
...
//   products: LatestProductForBooth[];
...
//   onProductSelect,
// }) => {
//   const [selectedProduct, setSelectedProduct] = useState<LatestProductForBooth | null>(null);
//   const [open, setOpen] = useState(false);

//   const handleOpen = (product: LatestProductForBooth) => {
...
interface ProductTableForBoothProps {
  products: LatestProductForBooth[];
  selectedProducts: string[];
  onProductSelect: (product: LatestProductForBooth) => void;
}
